...
import { CaretLeftIcon, CaretRightIcon, StorefrontIcon } from '@phosphor-icons/react';
...
const ProductCard = ({ product }) => (
    <div className="product-card--vitamin h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
        <Link
...
const VitaminOne = () => {
    return (
        <section className="vitamin-one py-16">
                        ...
                        <div className="col-md-4">
                            <div className="position-relative rounded-16 overflow-hidden p-28 z-1 text-center">
                                ...
                                <div className="p-2">
                                    ...
                                    <h5 className="text-base mb-3 fw-semibold">Vitamins & Supplements</h5>
